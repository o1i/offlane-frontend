...
export interface LbInstance {name: string, lehrer: string, ort: string, status: LbStatus, slot: number, kw: number, id: number, current: number, soft: number, hard: number, start_frac: number};
